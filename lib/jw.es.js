...
var ColumnList = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["render", _sfc_render]]);
...
var Table = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["__scopeId", "data-v-4c22d9c5"]]);
const TablePlugin = {
  install(app) {
        ...
        unref(baseDialog).footer ? {
          ...
          fn: withCtx(() => [
            createElementVNode("span", _hoisted_1$2, [
              renderSlot(_ctx.$slots, "prefixFooter", {}, void 0, true),
              createVNode(_component_el_button, { onClick: handleClose }, {
                default: withCtx(() => [
                  createTextVNode(toDisplayString(unref(baseDialog)["cancel-text"] || "\u53D6\u6D88"), 1)
                ]),
                _: 1
              }),
              unref(baseDialog).type == "del" ? (openBlock(), createBlock(_component_el_button, {
                ...
                default: withCtx(() => [
                  createTextVNode(toDisplayString(unref(baseDialog)["save-text"] || "\u5220\u9664"), 1)
                ]),
                _: 1
                ...
                default: withCtx(() => [
                  createTextVNode(toDisplayString(unref(baseDialog)["save-text"] || "\u786E\u5B9A"), 1)
                ]),
                _: 1
              }, 8, ["loading"])),
              renderSlot(_ctx.$slots, "suffixFooter", {}, void 0, true)
            ])
          ]),
          key: "0"
        } : void 0
...
var Dialog = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-020ac921"]]);
const DialogPlugin = {
  install(app) {
...
const _sfc_main$4 = defineComponent({
  ...
  setup(__props) {
    ...
    watch(
      () => props.config,
      (value) => {
        baseConfig.value = merge$1(baseConfig.value, value);
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createBlock(_component_el_drawer, mergeProps({
        ...
        "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => isRef(visible) ? visible.value = $event : visible = $event),
        title: unref(baseConfig).title,
        class: unref(baseConfig).customClass,
        size: unref(baseConfig).width,
        "before-close": unref(onCancel)
      }, _ctx.$attrs), {
        footer: withCtx(() => [
...
const DrawerPlugin = {
  install(app) {
    app.component("my-drawer", _sfc_main$4);
  }
};
...
const _sfc_main$2 = defineComponent({
  ...
  setup(__props) {
    return (_ctx, _cache) => {
      ...
      return __props.item.type == "input" || __props.item.type == "hidden" ? (openBlock(), createBlock(_component_el_input, mergeProps({
        key: 0,
        class: "widthP100",
        ...
        __props.item.extra && __props.item.extra.prefix ? {
          name: "prefix",
          fn: withCtx(() => [
            createTextVNode(toDisplayString(__props.item.extra.prefix), 1)
          ]),
          key: "0"
        } : void 0,
        __props.item.extra && __props.item.extra.suffix ? {
          name: "suffix",
          fn: withCtx(() => [
            createTextVNode(toDisplayString(__props.item.extra.suffix), 1)
          ]),
          key: "1"
        } : void 0
      ]), 1040, ["modelValue", "placeholder", "clearable", "disabled"])) : __props.item.type == "number" || __props.item.type == "numberhidden" ? (openBlock(), createBlock(_component_el_input_number, mergeProps({
        key: 1,
        class: "widthP100",
        modelValue: __props.formState[__props.item.code],
      ...
      }), null, 16, ["modelValue", "placeholder", "disabled"])) : __props.item.type == "textarea" ? (openBlock(), createBlock(_component_el_input, mergeProps({
        key: 2,
        class: "widthP100",
        modelValue: __props.formState[__props.item.code],
      ...
      }), null, 16, ["modelValue", "placeholder", "disabled"])) : __props.item.type == "password" ? (openBlock(), createBlock(_component_el_input, mergeProps({
        key: 3,
        class: "widthP100",
        modelValue: __props.formState[__props.item.code],
      ...
      }), null, 16, ["modelValue", "placeholder", "disabled", "clearable"])) : __props.item.type == "radio" ? (openBlock(), createBlock(_component_el_radio_group, mergeProps({
        key: 4,
        modelValue: __props.formState[__props.item.code],
        ...
        default: withCtx(() => [
          (openBlock(true), createElementBlock(Fragment, null, renderList(__props.item.dataFormat, (dataFormat) => {
            return openBlock(), createBlock(_component_el_radio, {
              disabled: dataFormat.disabled,
              label: dataFormat[__props.item.fieldName ? __props.item.fieldName.value || "value" : "value"]
            }, {
              default: withCtx(() => [
                createTextVNode(toDisplayString(dataFormat[__props.item.fieldName ? __props.item.fieldName.label || "label" : "label"]), 1)
              ]),
              _: 2
            }, 1032, ["disabled", "label"]);
          }), 256))
        ...
        _: 1
      }, 16, ["modelValue", "disabled"])) : __props.item.type == "checkbox" ? (openBlock(), createBlock(_component_el_checkbox_group, mergeProps({
        key: 5,
        modelValue: __props.formState[__props.item.code],
        ...
        _: 1
      }, 16, ["modelValue", "disabled"])) : __props.item.type == "select" ? (openBlock(), createBlock(_component_el_select, mergeProps({
        key: 6,
        class: "widthP100",
        modelValue: __props.formState[__props.item.code],
        ...
        _: 1
      }, 16, ["modelValue", "multiple", "placeholder", "disabled", "clearable"])) : __props.item.type == "treeSelect" ? (openBlock(), createBlock(_component_el_tree_select, mergeProps({
        key: 7,
        class: "widthP100",
        modelValue: __props.formState[__props.item.code],
      ...
      }, __props.item.extra), null, 16, ["modelValue", "multiple", "show-checkbox", "data", "check-on-click-node", "filter-node-method"])) : __props.item.type == "cascader" ? (openBlock(), createBlock(_component_el_cascader, mergeProps({
        key: 8,
        class: "widthP100",
        modelValue: __props.formState[__props.item.code],
      ...
      }), null, 16, ["modelValue", "options", "props", "placeholder", "disabled", "clearable", "filter-method"])) : __props.item.type == "switch" ? (openBlock(), createBlock(_component_el_switch, mergeProps({
        key: 9,
        modelValue: __props.formState[__props.item.code],
      ...
      }), null, 16, ["modelValue"])) : __props.item.type == "datetime" || __props.item.type == "date" || __props.item.type == "week" || __props.item.type == "month" || __props.item.type == "year" || __props.item.type == "dates" ? (openBlock(), createBlock(_component_el_date_picker, mergeProps({
        key: 10,
        class: "widthP100I",
        modelValue: __props.formState[__props.item.code],
      ...
      }), null, 16, ["modelValue", "type", "placeholder", "disabled", "clearable"])) : __props.item.type == "daterange" || __props.item.type == "monthrange" || __props.item.type == "datetimerange" ? (openBlock(), createBlock(_component_el_date_picker, mergeProps({
        key: 11,
        class: "widthP100I",
        modelValue: __props.formState[__props.item.code],
      ...
      }), null, 16, ["modelValue", "type", "range-separator", "start-placeholder", "end-placeholder", "placeholder", "disabled", "clearable"])) : __props.item.type == "time" ? (openBlock(), createBlock(_component_el_time_picker, mergeProps({
        key: 12,
        class: "widthP100I",
        modelValue: __props.formState[__props.item.code],
      ...
      }), null, 16, ["modelValue", "placeholder", "disabled", "clearable"])) : __props.item.type == "timeRange" ? (openBlock(), createBlock(_component_el_time_picker, mergeProps({
        key: 13,
        class: "widthP100I",
        modelValue: __props.formState[__props.item.code],
      ...
      }), null, 16, ["modelValue", "range-separator", "start-placeholder", "end-placeholder", "placeholder", "disabled", "clearable"])) : __props.item.type == "timeSelect" ? (openBlock(), createBlock(_component_el_time_select, mergeProps({
        key: 14,
        class: "widthP100I",
        modelValue: __props.formState[__props.item.code],
      ...
      }), null, 16, ["modelValue", "start", "step", "end", "placeholder", "disabled", "clearable"])) : createCommentVNode("", true);
    };
  }
});
...
var _hoisted_1288 = {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 1024 1024"
}, _hoisted_2288 = /* @__PURE__ */ createElementVNode(
  "path",
  {
    fill: "currentColor",
...
const _sfc_main$1 = defineComponent({
  ...
  setup(__props, { expose: __expose }) {
      ...
      (value) => {
        ...
        if ((_a = configData.value) == null ? void 0 : _a.length) {
          configData.value.map((el) => {
            ...
            if (el.checkFunName) {
              rulesRef[el.code].push({
                validator: (rule, value2, callback) => methods.checkFunction(rule, value2, callback, el.checkFunName, el)
              });
            }
    ...
    const methods = {
      checkFunction: (rule, value, callback, checkFunName, item) => {
            ...
            unref(base).inline ? (openBlock(true), createElementBlock(Fragment, { key: 0 }, renderList(unref(configData), (item) => {
              return withDirectives((openBlock(), createBlock(_component_el_form_item, {
                ...
                label: withCtx(() => [
                  ...
                  item.labelTip ? (openBlock(), createBlock(_component_el_tooltip, {
                    key: 0,
                    placement: "top-start"
                  }, {
                    content: withCtx(() => [
                      createElementVNode("span", null, toDisplayString(item.labelTip), 1)
                    ]),
                    default: withCtx(() => [
                ...
                default: withCtx(() => [
                  item.slot ? renderSlot(_ctx.$slots, item.slot, {
                    key: 0,
                    data: item
                  }, void 0, true) : (openBlock(), createBlock(_sfc_main$2, {
                    key: 1,
                    item,
                    formState,
                    methods
              ...
              default: withCtx(() => [
                (openBlock(true), createElementBlock(Fragment, null, renderList(unref(configData), (item) => {
                  return openBlock(), createElementBlock(Fragment, null, [
                    item.show ? (openBlock(), createBlock(_component_el_col, normalizeProps(mergeProps({ key: 0 }, item.grid || unref(base).grid)), {
                      default: withCtx(() => [
                        withDirectives(createVNode(_component_el_form_item, {
                          ...
                          default: withCtx(() => [
                            item.slot ? renderSlot(_ctx.$slots, item.slot, {
                              ...
                              _: 2
                            }, 1040, ["file-list", "disabled", "accept", "before-upload", "on-preview", "class"])) : (openBlock(), createBlock(_sfc_main$2, {
                              key: 2,
                              item,
                              formState,
                              methods
...
var Form = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-4bcc5d1f"]]);
const FormPlugin = {
  install(app) {
  ...
  setup(__props, { expose: __expose }) {
    ...
    watch(
      ...
      (value) => {
        if (value && value.formConfigData.length) {
          slotList.value = value.formConfigData.filter((el) => el.slot).map((el) => el.slot);
        }
      },
      {
        immediate: true,
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1, [
        (openBlock(true), createElementBlock(Fragment, null, renderList(unref(lists), (item) => {
          return openBlock(), createElementBlock("div", {
            ...
            createElementVNode("div", {
              class: "my-bordered",
              style: normalizeStyle({ "border-color": !__props.borderColor ? "transparent" : __props.borderColor })
            }, [
              createVNode(_component_my_form, {
                formConfig: item.formConfig,
                ref_for: true,
                ref: (el) => unref(setRefMap)(el, item)
              }, createSlots({ _: 2 }, [
                renderList(unref(slotList), (slot) => {
                  return {
                    name: slot,
                    fn: withCtx((scope) => [
            ...
            createVNode(_component_el_space, { style: { "margin-left": "8px" } }, {
              default: withCtx(() => [
                createVNode(_component_el_button, {
                  disabled: item.disabled,
                  icon: unref(minus_default),
                  type: "danger",
                  onClick: ($event) => unref(methods).del(item)
                }, null, 8, ["disabled", "icon", "onClick"]),
                __props.type == "right" ? (openBlock(), createBlock(_component_el_button, {
                  key: 0,
                  icon: unref(plus_default),
                  type: "primary",
                  style: { width: "100%" },
                  onClick: unref(methods).add
        ...
        renderSlot(_ctx.$slots, "content", {}, void 0, true),
        __props.type == "bottom" ? (openBlock(), createElementBlock("div", _hoisted_2, [
          createVNode(_component_el_button, {
            round: "",
            icon: unref(plus_default),
            type: "primary",
...
var AddForms = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-242c86a1"]]);
...
const MYUiPlugin = {
  install(app) {
    ...
    (_c = DrawerPlugin.install) == null ? void 0 : _c.call(DrawerPlugin, app);
    (_d = PaginationPlugin.install) == null ? void 0 : _d.call(PaginationPlugin, app);
    (_e = FormPlugin.install) == null ? void 0 : _e.call(FormPlugin, app);
    (_f = AddFormsPlugin.install) == null ? void 0 : _f.call(AddFormsPlugin, app);
  }
};
export { AddForms, AddFormsPlugin, Dialog, DialogPlugin, _sfc_main$4 as Drawer, DrawerPlugin, Form, FormPlugin, Pagination, PaginationPlugin, Table, TablePlugin, MYUiPlugin as default };
