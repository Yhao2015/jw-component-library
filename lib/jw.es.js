  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock(Fragment, null, [
        ...
        unref(baseConfig).pagination ? (openBlock(), createBlock(_component_my_pagination, {
          key: 0,
...
const _sfc_main = defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    return (_ctx, _cache) => {
      ...
      const _component_el_dialog = resolveComponent("el-dialog");
      return openBlock(), createElementBlock(Fragment, null, [
        unref(isRefresh) ? (openBlock(), createBlock(_component_el_form, {
          key: 0,
          ...
          ref_key: "modelRef",
          ref: modelRef,
          style: normalizeStyle({ "--itemBottom": unref(base)["item-bottom"] })
        }, {
          default: withCtx(() => [
          ...
          _: 3
        }, 8, ["model", "rules", "inline", "label-position", "label-width", "label-suffix", "hide-required-asterisk", "require-asterisk-position", "inline-message", "status-icon", "style"])) : createCommentVNode("", true),
...
export { Dialog, DialogPlugin, Form, FormPlugin, Pagination, PaginationPlugin, Table, TablePlugin, JWPlugin as default };
